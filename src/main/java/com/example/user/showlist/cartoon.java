...
public class cartoon extends Activity implements
        AdapterView.OnItemClickListener {

    public static final String[] titles = { "ANIMAX","CARTOON NETWORK","CHINTU TV","DISNEY","DISNEY-XD","HUNGAMA","POGO"};

   /* public static final String[] descriptions = new String[] {
            "Countries in Asia",
            "Countries in Africa" };*/

    public static final Integer[] images = { R.drawable.animax,
            R.drawable.cn,R.drawable.chintu,R.drawable.dis,R.drawable.xd,R.drawable.hungama,R.drawable.pogo};
    ...
    protected void showCustomDialog(final int position) {
        ...
        final Dialog dialog = new Dialog(cartoon.this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("pos",(position+29));
